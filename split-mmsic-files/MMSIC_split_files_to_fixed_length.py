            ...
            if cnt_total == cnt_lines_docheader + cnt_lines_docline + cnt_lines_doctax + cnt_lines_nosplit:
                ...
                try:
                    ...
                    for i in split_files:
                        ...
                        mv_blob(bucket_name, blob.name, bucket_name,
                                f"{archived_folder}{timestamp_folder}{i}.{current_file_name}", 1)
                except:
                    print('Exception occured')
                else:
                    mv_blob(bucket_name, f"{folder_name}{current_file_name}", bucket_name,
                            f"{archived_folder}{timestamp_folder}{current_file_name}", 2)
            else:
